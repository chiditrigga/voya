...
const FlightSearch: React.FC<FlightSearchProps> = ({ onClose }) => {
    ...
    return (
        ...
        >
            <h2 className="text-3xl font-semibold mb-6 text-center text-gray-800">Flight Search</h2>
    ...
    <div className="mt-6 h-64 overflow-y-auto">
        ...
        <div className="space-y-4">
            {airlines.map((airline) => (
                <div key={airline.iataCode} onClick={() => handleFlightClick(airline)} className="flex items-center p-4 border rounded shadow-sm hover:shadow-lg hover:cursor-pointer hover:opacity-50 ">
                    <img src={airline.logoUrl} alt={airline.name} className="mr-4 w-48 h-48" />
                    <div>
