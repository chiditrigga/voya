...
const HotelSearch: React.FC<HotelSearchProps> = ({ onClose }) => {
    ...
    const handleHotelClick = (hotel: Hotel) => {
        ...
        console.log("Newly saved Hotels:", savedHotels); // Debug log
    };
    ...
    const fetchDestId = async (location: string): Promise<void> => {
        try {
            ...
            setError(`Too Many Requests - You have exceeded the MONTHLY quota for requests on your current plan, BASIC. Upgrade your plan at https://rapidapi.com/DataCrawler/api/booking-com15. ${error}`);
    ...
    <div className="mt-4 h-96 overflow-y-auto">
        ...
        <div className="space-y-4">
            {hotels.length > 0 ? (
                    ...
                    >
                        ...
                        <div className="flex-1 sm:ml-4">
                            ...
                            <p className="text-gray-600 text-sm mb-2">
                                {hotel.property.shortDescription || 'No description available.'}
                            </p>
                            <div className="flex items-center space-x-2 text-gray-600 text-sm">
                                ...
                                <span>
                                    {hotel.property.reviewsStats?.combinedNumericStats.average || 'N/A'} (
                                    {hotel.property.reviewsStats?.combinedNumericStats.total || '0'})
                                </span>
                        ...
                        <div className="text-right sm:ml-4">
                            <p className="text-xl font-bold text-gray-800">
                                ${hotel.property.priceBreakdown.grossPrice.value || 'N/A'}
                            </p>
                ...
                <p className="text-gray-500 text-sm mb-2">No hotels available.</p>
            )}
        </div>
    </div>
)}
